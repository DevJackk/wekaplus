...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/wekafile/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,913812904,1965297568,18908191571890819157}   
...
var = true 
elseif tonumber(user_id) == tonumber(18908191571890819157) then
var = true  
...
local UserName = (data.username_ or "QIIlIIU")
...
local Text = 'اهلا بك في العاب سورس ويكا بلص 🌚\nاختار من القائمه\n'
local Key = {
{'تويت','صراحه'},
...
if text == 'مبرمج سورس ويكا بلص' then 
local Text = [[ 
『 𝒂.𝒘𝒆𝒌𝒂 』𓄁︎
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '『 𝒂.𝒘𝒆𝒌𝒂 』𓄁︎️', url="t.me/ali_wekaaaa"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'المبرمج جاك' then 
local Text = [[ 
🖤 𝑱𝑨𝑪𝑲 🖤
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '🖤 𝑱𝑨𝑪𝑲 🖤︎', url="t.me/V_P_E"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐂𝐇 𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒', url="http://t.me/QIIlIIU"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
os.execute('wget https://raw.githubusercontent.com/jack1eljoker1/wekaplus/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'ᯓ تم تحديث السورس \nᯓ لديك اخر اصدار لسورس ويكا بلص\nᯓ الاصدار » { 1v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'ᯓ اصدار سورس ويكا بلص \nᯓ الاصدار »{ 1v}')
end
...
usertext = '\nᯓ العضو » ['..result.title_..'](t.me/'..(username or 'QIIlIIU')..')'
status  = '\nᯓ تم ترقيته مطور'
...
usertext = '\nᯓ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'QIIlIIU')..')'
status  = '\nᯓ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'ᯓ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'QIIlIIU')..') \nᯓ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"ᯓ العضو : {["..data.first_name_.."](T.ME/QIIlIIU)}\nᯓ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
print("it is Bot")
Namebot = (database:get(bot_id..'Name:Bot') or 'ويكا بلص')
...
send(msg.chat_id_,0, "ᯓ عذرا » {["..data.first_name_.."](T.ME/QIIlIIU)}\nᯓ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 『 𝒂.𝒘𝒆𝒌𝒂 』𓄁︎',url="t.me/ali_wekaaaa"},{text = ' 𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒',url="https://telegram.me/Ali_wekabot?startgroup=start"}},
{{text = ' - 𝐂𝐇 𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒', url="t.me/QIIlIIU"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/chweka&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'ᯓ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'QIIlIIU')..') \nᯓ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'ᯓ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'QIIlIIU')..') \nᯓ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(18908191571890819157) then  
send(msg.chat_id_, msg.id_, "ᯓ لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1965297568) then  
send(msg.chat_id_, msg.id_, "ᯓ لا تستطيع كتم او حظر او تقييد المبرمج جاك")
return false 
end
...
if tonumber(result.id_) == tonumber(18908191571890819157) then  
send(msg.chat_id_, msg.id_, "ᯓ لا تستطيع حظر او كتم او طرد مطور السورس")
return false 
end

if tonumber(result.id_) == tonumber(913812904) then  
send(msg.chat_id_, msg.id_, "ᯓ لا تستطيع حظر او كتم او طرد مبرمج سورس ويكا بلص")
return false 
end

if tonumber(result.id_) == tonumber(1965297568) then  
send(msg.chat_id_, msg.id_, "ᯓ لا تستطيع حظر او كتم او طرد المبرمج جاك")
return false 
end
...
if tonumber(userid) == tonumber(18908191571890819157) then  
send(msg.chat_id_, msg.id_, "ᯓ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
...
send(msg.chat_id_, msg.id_, "ᯓ لا تستطيع كتم او حظر او تقييد مبرمج سورس ويكا بلص")
return false 
end
...
if DevBOYKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/jack1eljoker1/wekafile/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\nᯓ اهلا بك في متجر ملفات ويكا بلص\nᯓ ملفات السورس ↓\n 𓇠 ⟼⟼⟼𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒⟻⟻⟻•\n\n"
local TextE = "\n 𓇠 ⟼⟼⟼𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒⟻⟻⟻•\nᯓ علامة تعني { ✓ } ملف مفعل\nᯓ علامة تعني { ✘ } ملف معطل\nᯓ قناة سورس ويكا بلص ↓\n".."ᯓ [اضغط هنا لدخول](t.me/QIIlIIU) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/jack1eljoker1/wekafile/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_,"ᯓ عذرا الملف لايدعم سورس ويكا بلص \n") 
end
return false
end
...
local UserName = (b.username_ or "QIIlIIU")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\nᯓ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'QIIlIIU')..')'
status  = '\nᯓ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\nᯓ العضو » '..userid..''
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/photojack&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'ويكا' or text == 'علي ويكا' or text == 'علي' then
local Text =[[
『 𝒂.𝒘𝒆𝒌𝒂 』𓄁︎
]]
keyboard = {} 
...
{
{text = '『 𝒂.𝒘𝒆𝒌𝒂 』𓄁︎', url = "https://t.me/ali_wekaaaa"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/photoweka&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nᯓ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'QIIlIIU')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\nᯓ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'QIIlIIU')..')'..'\nᯓ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ويكا بلص').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ويكا بلص')
local BOYKA_Msg = {
'اؤمرني 🥺💕.',
'ليا اسم خد بالك ☹️.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ويكا بلص').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'QIIlIIU')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'ٴᯓ  𓇠 ⟼⟼⟼𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒⟻⟻⟻•ᯓ○ٴ\nᯓ 彡 .[𝐖𝐄𝐊𝐀 𝐏𝐋𝐔𝐒](t.me/QIIlIIU)➢ ')
end
